...
export default function Project() {
  ...
  return <div className="min-h-screen bg-[#fbf8ef] text-[#29221e]">
    <header className="sticky top-0 z-30 border-b border-[#d8cdbb] bg-[#fbf8ef]/95 backdrop-blur"><div className="container flex h-[72px] items-center justify-between"><a href="/" className="inline-flex items-center gap-2 text-sm font-semibold transition hover:text-[#b84236]"><ArrowLeft size={18}/> 回到今日書架</a><a href="/" className="flex items-center gap-2"><img className="h-8 w-8" src="/manus-storage/odj-logo-seal_44c2c579.png" alt="老東家"/><span className="font-display text-lg font-black tracking-[0.08em]">老東家</span></a></div></header>
